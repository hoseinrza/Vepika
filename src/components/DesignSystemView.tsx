      ...
      <div className="bg-slate-900 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-xl border border-slate-800">
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <RedwebsLogo theme="dark" size="lg" showTagline />
            <button
              onClick={onBack}
          ...
          <div className="max-w-3xl space-y-3">
            <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-white">
              سیستم دیزاین و هویت بصری ردوبز (Redwebs Design System)
            </h1>
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              راهنمای جامع هویت بصری، پالت رنگ‌های روانشناختی، تایپوگرافی استاندارد فارسی و کامپوننت‌های رابط کاربری پلتفرم آموزشی ردوبز.
            </p>
          </div>
        ...
        <section className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="h-28 rounded-xl bg-[#DC2626] flex items-end p-3 text-white shadow-inner">
                <span className="font-mono text-xs font-bold">#DC2626</span>
              </div>
              <div className="space-y-1">
                <h3 className="font-bold text-slate-900 text-sm">Redwebs Red (اصلی)</h3>
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="font-bold text-slate-900 text-sm">Redwebs Dark (تاریک)</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
            ...
            {/* Accent Purple */}
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <div className="h-28 rounded-xl bg-[#F97316] flex items-end p-3 text-white shadow-inner">
                <span className="font-mono text-xs font-bold">#F97316</span>
              </div>
              <div className="space-y-1">
                <h3 className="font-bold text-slate-900 text-sm">Redwebs Orange (اکسنت فرعی)</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
        ...
        <section className="space-y-8 animate-in fade-in duration-300">
          <div className="space-y-2">
            <h2 className="font-lalezar text-2xl sm:text-3xl text-slate-900 flex items-center gap-2.5 tracking-wide">
              <span className="w-3 h-3 rounded-full bg-red-600" />
              <span>ترکیب تایپوگرافی ردوبز (لاله‌زار + وزیرمتن + جت‌برینز مونو)</span>
            </h2>
            <p className="text-xs sm:text-sm text-slate-500">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6">
            <div className="pb-6 border-b border-slate-100 space-y-2">
              <span className="text-xs font-mono font-bold text-red-600">Display / H1 - Lalezar Font (عناوین و برندینگ)</span>
            ...
            <div className="pb-6 border-b border-slate-100 space-y-2">
              <span className="text-xs font-mono font-bold text-red-600">Display / H2 - Lalezar Font (عناوین بخش‌ها و کارت‌ها)</span>
            ...
            <div className="pb-6 border-b border-slate-100 space-y-2">
              <span className="text-xs font-mono font-bold text-red-600">H3 - Vazirmatn 18px / 1.125rem - Font Weight 700 (Bold)</span>
            ...
            <div className="pb-6 border-b border-slate-100 space-y-2">
              <span className="text-xs font-mono font-bold text-red-600">Body Text - Vazirmatn 16px / 1rem - Line Height 2.0</span>
              <p className="text-slate-700 text-base leading-loose max-w-4xl text-justify">
                تایپوگرافی اصولی یکی از اساسی‌ترین فاکتورهای افزایش زمان حضور کاربر در صفحه (Dwell Time) است. در رسانه ردوبز، تمامی پاراگراف‌ها با فاصله خطوط محاسبه‌شده و کنتراست رنگی متناسب با استانداردهای WCAG AA رندر می‌شوند تا چشم خواننده در مقالات طولانی خسته نشود.
              </p>
            </div>

            <div className="space-y-2">
              <span className="text-xs font-mono font-bold text-red-600">Code & Monospace - JetBrains Mono / 14px</span>
              <div className="font-mono text-sm bg-slate-950 text-red-300 p-4 rounded-xl dir-ltr text-left">
                const redwebs = {'{'} brand: 'Redwebs', mission: 'Learn. Build. Grow.', language: 'Persian' {'}'};
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6">
            <div className="flex flex-wrap items-center gap-4">
              <button className="px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl text-xs font-bold transition-all shadow-xs hover:shadow-md cursor-pointer flex items-center gap-2">
              ...
              <button className="px-4 py-2.5 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl text-xs font-bold transition-all cursor-pointer">
                دکمه متنی (Ghost)
              </button>
      ...
      {activeTab === 'cards' && (
        <section className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Info Callout */}
            <div className="bg-red-50/80 border border-red-200 p-5 rounded-2xl space-y-2">
              <div className="flex items-center gap-2 text-red-800 font-bold text-sm">
                <Info className="w-4 h-4 text-red-600" />
                <span>نکته آموزشی ردوبز</span>
              </div>
        ...
        <section className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="bg-slate-900 rounded-2xl overflow-hidden border border-slate-800 shadow-lg">
            <div className="bg-slate-950 px-5 py-3 border-b border-slate-800 flex items-center justify-between">
              ...
              <button
                onClick={() => handleCopy(`// کدهای بهینه‌سازی ردوبز\nadd_action('init', 'redwebs_speed_booster');`, 'snippet-demo')}
            ...
            <pre className="p-5 text-sm font-mono text-slate-200 overflow-x-auto dir-ltr text-left leading-relaxed">
              <code>{`// کدهای بهینه‌سازی سرعت و امنیت ردوبز
